...
namespace WSU\Theme\SFS411\LatestCustomPosts\Block;
...
function enqueue_block_editor_assets() {
	...
	wp_enqueue_script(
		...
		get_stylesheet_directory_uri() . '/blocks/latest-custom-posts/build/index.js',
		array(
			'wp-blocks',
			'wp-i18n',
			'wp-element',
	...
	wp_enqueue_style(
		...
		get_stylesheet_directory_uri() . '/blocks/latest-custom-posts/css/editor.css',
		array(
			'wp-edit-blocks',
		),
		block_version()
